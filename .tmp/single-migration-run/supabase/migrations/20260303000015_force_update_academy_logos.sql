-- Forçar atualização dos logos das academias
-- Executar manualmente via SQL Editor ou via migration one-time
...
SELECT COUNT(*) as total_academias_mapeadas FROM public.academy_logos;
