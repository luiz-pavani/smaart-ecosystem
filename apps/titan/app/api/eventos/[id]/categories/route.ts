...
export async function POST(
  ...
  const { age_group_id, weight_class_id, genero, kyu_dan_min, kyu_dan_max, nome_display, taxa_inscricao, limite_inscritos, tempo_luta_seg, golden_score_seg } = body
...
export async function PATCH(
  ...
  const allowed = ['nome_display', 'genero', 'taxa_inscricao', 'limite_inscritos', 'tempo_luta_seg', 'golden_score_seg', 'intervalo_entre_lutas_seg', 'kyu_dan_min', 'kyu_dan_max', 'ativo', 'age_group_id', 'weight_class_id']
