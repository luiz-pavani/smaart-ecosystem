...
export async function GET() {
  ...
  const [
    ...
    supabaseAdmin.from('stakeholders').select('id, nome_completo, nome_usuario, email, telefone, funcao, genero, academia_id, federacao_id, kyu_dan_id, data_nascimento, instagram, role').eq('id', user.id).maybeSingle(),
