/*
  This is the new standardized /portal/page.tsx, moved from /portais/page.tsx.
  All logic and UI remain the same, but the route is now /portal.
*/
...
export default function PortalPage() {
  ...
  const loadUserRoles = async () => {
    try {
      ...
      setError('Erro ao carregar portal disponível')
    } finally {
      setLoading(false)
    }
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-300 text-lg">Carregando portal disponível...</p>
        </div>
      </div>
    )
  }
